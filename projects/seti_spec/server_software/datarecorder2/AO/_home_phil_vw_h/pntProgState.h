 ...
 *18oct07 - <pjp038> added model correction for current encoder az,za
 *             double   modelCorEncAzZa[2];  (in radians)
 *           When going encoder az/za back to Ra,Dec:
 *           Subtract this value from encoder az,za to get az,za
 *           with no model correction.
*/
...
typedef struct {
	    ...
	    double			modelCorEncAzZa[2]; /*radians   pjp038*/
