...
echo "copying dr2_config_test into dr2_config"
cp dr2_config_test dr2_config
...
echo "starting diskbuf delete script"
sudo ./delete_diskbufs.bash > /dev/null &

echo "starting new run"
sudo ./setispec_dr &> output

sudo killall -9 delete_diskbufs.bash
