...
/* #pragma ident "@(#)libedt.h	1.196 06/21/04 EDT" */
...
#define EDTAPI _declspec(dllexport)
...
EDTAPI HANDLE edt_opendir(char *dirname);
EDTAPI int edt_readdir(HANDLE h, char *name);
EDTAPI void edt_closedir(HANDLE h);
...
EDTAPI u_int             edt_mapmem(EdtDev *edt_p, u_int addr, int size) ;
...
#define EDT_NT_IOCTL	_IO(EDT_IOC_MAGIC, 1)
#endif

#ifdef sgi

#define EDT_NT_IOCTL        40

#endif

#if defined(__sun) || defined (_NT_) || defined(VXWORKS)
