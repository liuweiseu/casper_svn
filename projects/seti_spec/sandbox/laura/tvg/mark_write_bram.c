...
/*
Mark's bram_write program modified by 
Laura to include optional scaling argument
...
arg 6 is OPTIONAL scaling factor multiplied by input data
== OUTPUT (stdout) ==
