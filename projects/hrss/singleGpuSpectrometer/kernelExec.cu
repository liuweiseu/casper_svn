...
void convert_to_float_exec(char *devSignalData, float *devPartSumRe, float *devPartSumIm, float *devAvgRe, float *devAvgIm, cufftComplex *devFFTData){
	int avgGrid, subGrid;
...
void calc_over_threshold_exec(float *devPowerData, outputStruct *devOutputData){
