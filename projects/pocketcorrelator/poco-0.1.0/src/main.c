...
static void startudpdump_cmd(int argc, char **argv)
{
  ...
  dumpbrams[1]  = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_AB_REAL_BASEADDR);
  dumpbrams[2]  = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_AB_IMAG_BASEADDR);
  dumpbrams[3]  = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_BB_REAL_BASEADDR);
  dumpbrams[4]  = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_AC_REAL_BASEADDR);
  dumpbrams[5]  = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_AC_IMAG_BASEADDR);
  dumpbrams[6]  = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_BC_REAL_BASEADDR);
  dumpbrams[7]  = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_BC_IMAG_BASEADDR);
  dumpbrams[8]  = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_CC_REAL_BASEADDR);
  dumpbrams[9]  = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_BD_REAL_BASEADDR);
  dumpbrams[10] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_BD_IMAG_BASEADDR);
  dumpbrams[11] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_CD_REAL_BASEADDR);
  dumpbrams[12] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_CD_IMAG_BASEADDR);
  dumpbrams[13] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_DD_REAL_BASEADDR);
  dumpbrams[14] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_AD_REAL_BASEADDR);
  dumpbrams[15] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_AD_IMAG_BASEADDR);
  dumpbrams[16] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_AE_REAL_BASEADDR);
  dumpbrams[17] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_AE_IMAG_BASEADDR);
  dumpbrams[18] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_AF_REAL_BASEADDR);
  dumpbrams[19] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_AF_IMAG_BASEADDR);
  dumpbrams[20] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_BE_REAL_BASEADDR);
  dumpbrams[21] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_BE_IMAG_BASEADDR);
  dumpbrams[22] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_BF_REAL_BASEADDR);
  dumpbrams[23] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE8_MUXED_BF_IMAG_BASEADDR);
