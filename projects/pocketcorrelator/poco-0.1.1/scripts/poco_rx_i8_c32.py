    ...
    def _process_packets(self):
        ...
        try:
            while not self._quit:
                ...
                p = pkt.unpack(correlator.get_a_packet())
                #print baseline_number, p['offset']
                ...
                if not p == None:
                    ...
                    if p['offset'] in [0,1]:
                        combine_data = self._auto_parse(p['data'][0:256])
                        ...
                        combine_data = self._auto_parse(p['data'][256:512])
                        full_int_data[:,baseline_number,0] = combine_data[::2]
                        full_int_data[:,baseline_number,1] = numpy.zeros_like(combine_data[::2])
                        baseline_number += 1
                        full_int_data[:,baseline_number,0] = combine_data[1::2]
                        ...
                        combine_data = self._auto_parse(p['data'][512:768])
                        full_int_data[:,baseline_number,0] = combine_data[::2]
                        full_int_data[:,baseline_number,1] = numpy.zeros_like(combine_data[::2])
                        baseline_number += 1
                        full_int_data[:,baseline_number,0] = combine_data[1::2]
                        ...
                        combine_data = self._auto_parse(p['data'][768:1024])
                        full_int_data[:,baseline_number,0] = combine_data[::2]
                        full_int_data[:,baseline_number,1] = numpy.zeros_like(combine_data[::2])
                        baseline_number += 1
                        full_int_data[:,baseline_number,0] = combine_data[1::2]
                        ...
                        combine_data = self._cross_parse(p['data'][0:256])
                        full_int_data[:,baseline_number,0] = combine_data[::2]
                        full_int_data[:,baseline_number+1,0] = combine_data[1::2]
                        
                        combine_data = self._cross_parse(p['data'][256:512])
                        full_int_data[:,baseline_number,1] = combine_data[::2]
                        full_int_data[:,baseline_number+1,1] = combine_data[1::2]
                        baseline_number += 2
                        
                        combine_data = self._cross_parse(p['data'][512:768])
                        full_int_data[:,baseline_number,0] = combine_data[::2]
                        full_int_data[:,baseline_number+1,0] = combine_data[1::2]
                        
                        combine_data = self._cross_parse(p['data'][768:1024])
                        full_int_data[:,baseline_number,1] = combine_data[::2]
                        full_int_data[:,baseline_number+1,1] = combine_data[1::2]
                        baseline_number += 2
