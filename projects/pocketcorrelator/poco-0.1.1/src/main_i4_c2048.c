...
#define NCHAN_PER_BRAM 1024
#define PKTS_PER_BRAM 4
#define BRAMS_PER_PKT 1
#define NBRAMS 16
#define DESIGN_NAME POCO4_QUAD_200_2K_04
#define DESIGN_NAME_STR "POCO4_QUAD_200_2K_04"
...
dumpbrams[0] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_AA_REAL_BASEADDR);
dumpbrams[1] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_AB_REAL_BASEADDR);
dumpbrams[2] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_AB_IMAG_BASEADDR);
dumpbrams[3] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_BB_REAL_BASEADDR);
dumpbrams[4] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_AC_REAL_BASEADDR);
dumpbrams[5] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_AC_IMAG_BASEADDR);
dumpbrams[6] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_BC_REAL_BASEADDR);
dumpbrams[7] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_BC_IMAG_BASEADDR);
dumpbrams[8] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_CC_REAL_BASEADDR);
dumpbrams[9] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_BD_REAL_BASEADDR);
dumpbrams[10] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_BD_IMAG_BASEADDR);
dumpbrams[11] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_CD_REAL_BASEADDR);
dumpbrams[12] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_CD_IMAG_BASEADDR);
dumpbrams[13] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_DD_REAL_BASEADDR);
dumpbrams[14] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_AD_REAL_BASEADDR);
dumpbrams[15] = CONCAT(XPAR_,DESIGN_NAME,_XENGINE4_AD_IMAG_BASEADDR);
