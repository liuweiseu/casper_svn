...
#define NCHAN_PER_BRAM 512
#define PKTS_PER_BRAM 2
#define BRAMS_PER_PKT 1
#define NBRAMS 32
#define DESIGN_NAME I_POCO8_256CH_V004_MOD
#define DESIGN_NAME_STR "I_POCO8_256CH_V004_MOD"
#define COMPILED_ON "17-Sep-2009"
