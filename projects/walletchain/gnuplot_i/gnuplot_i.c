...
/*
	$Id: gnuplot_i.c 433 2006-05-02 00:23:51Z hchen05 $
	$Author: hchen05 $
	$Date: 2006-05-01 17:23:51 -0700 (Mon, 01 May 2006) $
	$Revision: 433 $
 */
...
void gnuplot_setstyle(gnuplot_ctrl * h, char * plot_style) 
{
    if (strcmp(plot_style, "lines") &&
        ...
        strcmp(plot_style, "lines ls 6") &&
	strcmp(plot_style, "steps ls 6") &&
	strcmp(plot_style, "points ls 5")) {
