...
print ('''P_DOWN Setting the payload length to %i...'''%(opts.payload_len)),
print (check_result(write_all('p_down_payload_len', opts.payload_len)))

print ('''P_DOWN Setting the period to %i...'''%(opts.period)),
print (check_result(write_all('p_down_period', opts.period)))

print ('''P_DOWN Starting...'''),
print (check_result(write_all('p_down_run', 1)))


print ('''P_MUX_DOWN Setting the payload length to %i...'''%(opts.payload_len)),
print (check_result(write_all('p_mux_down_payload_len', opts.payload_len)))

print ('''P_MUX_DOWN Setting the period to %i...'''%(opts.period)),
print (check_result(write_all('p_mux_down_period', opts.period)))

print ('''P_MUX_DOWN Starting...'''),
print (check_result(write_all('p_mux_down_run', 1)))
