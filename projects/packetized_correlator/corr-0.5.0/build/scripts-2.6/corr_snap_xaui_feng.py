...
Revisions:
2010-07022: JRM Copied from corr_snap_xaui.py
'''
...
try:
    ...
    #            print ('HEADER RECEIVED')
                ...
                print '[%s] [Pkt@ %4i Len: %2i]     (MCNT %16u ANT: %1i, Freq: %4i)  RMS: X: %1.2f Y: %1.2f.  {X: %1.2f+%1.2fj (%2.1f & %2.1f bits), Y:%1.2f+%1.2fj (%2.1f & %2.1f bits)} {Pk: X,Y: %1.2f,%1.2f (%2.1f,%2.1f bits)}'%(c.fsrvs[f],\
                    pkt_hdr_idx,\
