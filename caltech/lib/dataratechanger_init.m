...
if ninputs > 1,
    ...
    reuse_block(blk, 'Add', 'xbsIndex_r3/AddSub', ...
        'precision', 'User Defined', ...
        'n_bits', num2str(log2(ninputs)), 'bin_pt', '0', ...
        'arith_type', 'Unsigned', 'Position', [650 140 685 170]);
    reuse_block(blk, 'ConsOne', 'xbsIndex_r3/Constant', ...
        'const', '1', 'n_bits', '1', 'Position',[600 180 635 200]);
    ...
    for k = 1:ninputs,
        reuse_block(blk, ['FIFO',num2str(k)], 'xbsIndex_r3/FIFO', ...
            'depth', fifolens{L+1}, 'Position', [600, 100+k*100, 650,170+k*100]);
        reuse_block(blk, ['Compare',num2str(k)], 'xbsIndex_r3/Relational', ...
            'latency', '0', 'mode', 'a=b', 'Position', [550, 150+k*100, 580, 170+k*100]);
        reuse_block(blk, ['Const',num2str(k)], 'xbsIndex_r3/Constant', ...
            'const', num2str(((k-1)*2^out_rate)+1), 'n_bits',num2str(fifo_rate_bits), 'Position', [510, 155+k*100, 530 , 170+k*100]);
