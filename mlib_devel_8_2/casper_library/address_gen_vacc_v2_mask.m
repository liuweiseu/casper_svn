...
reuse_block(cursys, 'block_counter', 'xbsIndex_r3/Counter', ...                                             
...
reuse_block(cursys, 'write_counter', 'xbsIndex_r3/Counter', ...
...
reuse_block(cursys, 'read_counter', 'xbsIndex_r3/Counter', ...
...
reuse_block(cursys, 'or0', 'xbsIndex_r3/Logical','Position', [65    200   85   220], 'logical_function', 'OR');
reuse_block(cursys, 'and0', 'xbsIndex_r3/Logical','Position', [65    250   85   270], 'logical_function', 'AND');
reuse_block(cursys, 'compare1', 'xbsIndex_r3/Relational','Position', [265 251 295 291],...
				 'latency', '1', 'explicit_period', 'on');
reuse_block(cursys, 'const10', 'xbsIndex_r3/Constant', ...
        'Position', [45    341   65   364], 'n_bits', 'counterBitWidth', 'const', 'valid_length/2'...
        , 'explicit_period', 'on');         
reuse_block(cursys, 'const11', 'xbsIndex_r3/Constant', ...
...
reuse_block(cursys, 'slice0', 'xbsIndex_r3/Slice',...       
...
reuse_block(cursys, 'slice6', 'xbsIndex_r3/Slice',...       
				'Position', [345 451 375 471], 'mode' , 'Lower Bit Location + Width','nbits','colCountBits');  
reuse_block(cursys, 'slice7', 'xbsIndex_r3/Slice',...                                                   
...
if blockRowBits == 0 
  ...
  reuse_block(cursys, 'concat3', 'xbsIndex_r3/Concat',...     
  ...
  reuse_block(cursys, 'slice8', 'xbsIndex_r3/Slice',...                                                                                                                                       
