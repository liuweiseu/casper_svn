...
for i = 1:length(iports),
    ...
    set_param([cursys,'/',iports{i}],'Port',num2str(i));
        ...
        add_block('xbsIndex_r3/Convert', [cursys,'/','convert_',gw_name], 'Position',[100 50*i 150 15+50*i], ...
            'arith_type', atype,...
            'n_bits', num2str(iport_widths(i)),...
            'bin_pt', num2str(bin_pt));
        add_block('xbsIndex_r3/Gateway Out', [cursys,'/',gw_name], 'Position',[175 50*i 225 15+50*i]);
...
for i = 1:length(oports),
    ...
    set_param([cursys,'/',oports{i}],'Port',num2str(i));
         ...
         add_block('xbsIndex_r3/Gateway In', [cursys,'/',gw_name], 'Position',[450 50*i 500 15+50*i], ...
            'arith_type', atype,...
