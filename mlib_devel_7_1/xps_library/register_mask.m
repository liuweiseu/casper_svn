...
switch get_param(cursys,'io_dir')
    case 'From Processor'
        ...
        add_block('xbsIndex_r3/Gateway In',[cursys,'/',gw_name],'Position', [230 50 290 70],...
    ...
    case 'To Processor'
        ...
        add_block('xbsIndex_r3/Gateway Out',[cursys,'/',gw_name],'Position', [150 50 190 70]);
        add_block('xbsIndex_r3/Convert',[cursys,'/convert'],'Position', [80 50 110 70],...
            'arith_type', get_param(cursys,'arith_type'),...
            'n_bits', num2str(bitwidth),...
            'bin_pt', num2str(bin_pt));
