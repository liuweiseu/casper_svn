...
if strcmp(get_param(myname, 'use_sim'), 'on')
    ...
    set_param([gcb, '/sim_wrapper/dram_sim'], 'sim_method', 'Use HDL Co-Simulation');
...
gateway_ins = find_system(gcb,'searchdepth',1,'FollowLinks', 'on','lookundermasks','all','masktype','Xilinx Gateway In');
