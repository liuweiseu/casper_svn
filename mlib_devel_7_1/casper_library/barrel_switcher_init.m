...
reuse_block(blk, 'Delay_sync', 'xbsIndex_r3/Delay', ...
...
for i=1:2^n_inputs,
    ...
    for j=1:n_inputs,
        reuse_block(blk, ['Mux', num2str(10*i + j)], 'xbsIndex_r3/Mux', ...
            'latency', '1', 'Position', [15+150*j, 67+80*i, 40+150*j, 133+80*i]);
    end
end
for j=1:(n_inputs-1),
    reuse_block(blk, ['Delay', num2str(j)], 'xbsIndex_r3/Delay', ...
        'Position', [15+150*j 15 45+150*j 45]);
end
for j=1:n_inputs,
    reuse_block(blk, ['Slice', num2str(j)], 'xbsIndex_r3/Slice', ...
