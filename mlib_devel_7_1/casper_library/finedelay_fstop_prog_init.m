...
% %  %%%%%%%%%% number of inputs.
 ...
 for i=1:n_input
     ...
     reuse_block(blk,name,'xbsIndex_r3/Register',...
            'Position',[135 y1+((i-1)*405) 175 y2+((i-1)*405)],...
            'en', 'on');
        
     name = ['FFT_Chnl_Cnt',num2str((i*2-1))];
     reuse_block(blk,name,'xbsIndex_r3/Counter',...
     ...
     reuse_block(blk,name,'xbsIndex_r3/Logical',...
    ...
    reuse_block(blk,name,'xbsIndex_r3/Constant',...
     ...
     reuse_block(blk,name,'xbsIndex_r3/Mult',...
 ...
 name = ['Relational_sel', num2str(i)];                
   ...
   reuse_block(blk,name,'xbsIndex_r3/Mux',...
   ...
   reuse_block(blk,name,'xbsIndex_r3/SineCosine',...
