...
if num_slice == 1,
  j=1;
  reuse_block(blk, ['Reinterp', num2str(j)],'xbsIndex_r3/Reinterpret', ...
  ...
  reuse_block(blk, 'Concat', 'xbsIndex_r3/Concat', 'num_inputs', num2str(num_slice), 'Position', [300 50 350 550]);
