...
reuse_block(blk, 'convert1', 'xbsIndex_r3/Convert', ...
...
reuse_block(blk, 'convert2', 'xbsIndex_r3/Convert', ...
    'arith_type', 'Signed  (2''s comp)', 'n_bits', num2str(BitWidthOut), ...
    'bin_pt', num2str(BitWidthOut-1), 'quantization', quantization, ...
    'overflow', 'Saturate', 'latency', num2str(add_latency), ...
...
for i=0:TotalTaps-1,
    for j=1:2,
        ...
        reuse_block(blk, slice_name, 'xbsIndex_r3/Slice', ...
        ...
        reuse_block(blk, reint_name, 'xbsIndex_r3/Reinterpret', ...
