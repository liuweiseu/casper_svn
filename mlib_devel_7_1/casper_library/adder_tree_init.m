...
reuse_block(blk, 'sync_delay', 'xbsIndex_r3/Delay', 'latency', num2str(stages*latency), ...
    ...
    while cur_n > 1,
        ...
        for j=1:cur_n,
            ...
            if j <= n_adds,
                ...
                blks{j} = addr;
                reuse_block(blk, addr, 'xbsIndex_r3/AddSub', ...
                    'latency', num2str(latency), 'pipeline', 'on', 'explicit_period', 'off',...
                ...
                blks{j} = dly;
                reuse_block(blk, dly, 'xbsIndex_r3/Delay', ...
