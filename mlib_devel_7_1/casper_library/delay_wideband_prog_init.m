...
if(strcmp(bram_type,'Single Port'))
    ...
    reuse_block(blk,'delay_offset','xbsIndex_r3/Constant',...
    ...
    reuse_block(blk,'delay_adder','xbsIndex_r3/AddSub',...
...
reuse_block(blk,'max_delay','xbsIndex_r3/Constant',...
...
reuse_block(blk,'delay_reg','xbsIndex_r3/Register',...
            'Position',[75 219 110 241],...
            'en', 'on');

            
reuse_block(blk,'max_delay_chk','xbsIndex_r3/Relational',...
            'Position',[170 244 210 286],...
             'mode', 'a<=b');
 
reuse_block (blk,'mux_delay','xbsIndex_r3/Mux',...
             'Position',[240 245 270 365],...
              'inputs', '2');
          
 
reuse_block(blk,'bram_rd_addrs','xbsIndex_r3/Slice',...
...
reuse_block(blk,'bs_sel','xbsIndex_r3/Slice',...
  ...
  reuse_block(blk,'delay_sel','xbsIndex_r3/Delay',...
   ...
   for i=1:((2^n_inputs_bits)-1)
        ...
        reuse_block(blk,name,'xbsIndex_r3/AddSub',...
...
%                     'Position',[750 y 780 y+10]) ;
        ...
        reuse_block(blk,name,'xbsIndex_r3/Convert',...
         ...
         reuse_block(blk,name,'xbsIndex_r3/Relational',...
                     'Position', [525 y+30 570 y+50], ...
                     'latency','0',... 
                     'mode','a>b');
                 
         name = ['Constant',num2str(i)];
         reuse_block(blk,name,'xbsIndex_r3/Constant',...
