...
katcp_port=7147
boffile='r_10gbe_demo_2009_Jul_27_1610.bof'
...
def get_gbe_config(dev_name):
    ...
    print 'XAUI Status: ',
    print '%2X%2X%2X%2X'%(port_dump[0x20],port_dump[0x21],port_dump[0x22],port_dump[0x23])
    print 'XAUI PHY config: '
    print '\tRX_eq_mix: %2X'%port_dump[0x20]
    print '\tRX_eq_pol: %2X'%port_dump[0x21]
    print '\tTX_pre-emph: %2X'%port_dump[0x22]
    print '\tTX_diff_ctrl: %2X'%port_dump[0x23]
    print 'ARP Table: '
    for i in range(256):
...
if __name__ == '__main__':
    ...
    p = OptionParser()
    p.set_usage('10gbe_demo.py <ROACH_HOSTNAME_or_IP> [options]')
...
try:
    ...
    sys.stdout.flush()
    fpga.write_int('gbe_core_rst',1)
    fpga.write_int('gbe_core_rst',0)
    ...
    if opts.arp:
        ...
        print '==============================='
        get_gbe_config(tx_core_name)
        print '\n\n============================'
        print '10GbE Receiver core details:'
        print '============================'
        get_gbe_config(rx_core_name)
